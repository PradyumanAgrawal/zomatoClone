...
class DiscoverShop extends StatefulWidget {
  ...
  List<String> pId;
  DiscoverShop({this.pId});
  @override
  _DiscoverShopState createState() => _DiscoverShopState();
}
        ...
        slivers: <Widget>[
          ...
          SliverList(
            delegate: SliverChildListDelegate(
              <Widget>[
                widget.pId.length==0?Center(child: Padding(
                    ...
                    builder: (BuildContext context, AsyncSnapshot snapshot) {
                      ...
                      return StreamBuilder(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return StreamBuilder(
                            stream: FirestoreService().getProductsFromShop(widget.pId),
                            builder: (context, snapshot) {
                              if (!snapshot.hasData)
                                return Center(
                                  child: SpinKitChasingDots(
