  ...
  Widget build(BuildContext context) {
    return SafeArea(
          child: Scaffold(
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  padding: EdgeInsets.only(top:bottonPadding,bottom:bottonPadding,left: rightpadding,right: rightpadding),
                    child: ClipRRect(
      ...
      children: <Widget>[
        ...
        Expanded(child: Icon(Icons.message, color: Color.fromARGB(255, 144, 28, 238),)),
      ],
    ),
                                  ),
                                  ),
      ...
      children: <Widget>[
        ...
        Expanded(child: Icon(Icons.message, color: Color.fromARGB(255, 144, 28, 238),)),
                  ...
                  Container(
                    padding: EdgeInsets.only(left: rightpadding,right: rightpadding),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(30),
                              child: SizedBox(
                                height: h,
      ...
      children: <Widget>[
        ...
        Expanded(child: Icon(Icons.email, color: Color.fromARGB(255, 144, 28, 238),)),
      ],
    ),
                                  ),
                                  ),
